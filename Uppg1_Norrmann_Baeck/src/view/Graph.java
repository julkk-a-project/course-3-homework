...
public class Graph extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		if(should1BeDrawn) {
			...
			//for drawing points for scores1
		...
		if(should2BeDrawn) {
			...
			//for drawing points for scores2
   ...
   private static void createAndShowGui() {
	...
	//compares size of scores1 and scores2 to handle drawing graph for different size stocks
	...
	//gets stock with more datapoints to read
	...
	//gets stock with less datapoints to read
